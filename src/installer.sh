...
then
        ...
        echo "Please provide GitHub access token if needed (format user:tokenstring), otherwise press [Enter]: "
...
then
        ...
        MODEL_GIT="https://${TOK}@github.com/cerr/${MODEL_NAME}.git"
fi
